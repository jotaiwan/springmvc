...
public class PersistenceConfig {
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan(new String[] { "com.book.data.entity" });
    ...
    private Properties hibernateProperties() {
        ...
        properties.put("metadata.hibernate.dialect", environment.getRequiredProperty("metadata.hibernate.dialect"));
        return properties;
    }
